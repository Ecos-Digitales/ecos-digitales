...
export const FeaturedHeadlines = ({ articles }: FeaturedHeadlinesProps) => {
  ...
  return (
    <section className="bg-[hsl(222,47%,11%)] py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0">
          {headlines.map((article, index) => (
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-bold text-white leading-snug line-clamp-3 group-hover:text-primary transition-colors">
                {article.title}
              </h3>
            </Link>
          ))}
